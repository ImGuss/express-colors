...
app.get('/colors', (req, res, next) => {
  ...
  const colorObj = {colorList : colors};

  res.render('color-view.ejs', colorObj);
});


app.get('/primary-colors', (req, res, next) => {

  const colorObj = {colorList : colors};

  res.render('category-view.ejs', colorObj);
});
...
app.get('/random', (req, res, next) => {
  ...
  res.render('random-view.ejs', randomColor);
